    ...
    public partial class Form2 : Form
    {
        ...
        private void Form2_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (isdeleteclick == false)
            {
                ...
                {
                    QA tempQA = dataQA.QAs1[indexed];
                    updateChangeTime(indexed, tempQA);
        ...
        void updateChangeTime(int index, QA tempQA) //get QA infor to xml
        {
            QAtoDatabase(index);
            if (tempQA.Answer != dataQA.QAs1[index].Answer || tempQA.Question != dataQA.QAs1[index].Question || tempQA.Topic != dataQA.QAs1[index].Topic)
            {
